...
// in simulator we redefine to format for VoterApp Developer console
...
{\
	NSString * exceptionName = [@"org.voterapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.voterapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIVoterAppNativeItemNone = -1, 
	UIVoterAppNativeItemSpinner = -2,
	UIVoterAppNativeItemProgressBar = -3,
	
	UIVoterAppNativeItemSlider = -4,
	UIVoterAppNativeItemSwitch = -5,
	UIVoterAppNativeItemMultiButton = -6,
	UIVoterAppNativeItemSegmented = -7,
	
	UIVoterAppNativeItemTextView = -8,
	UIVoterAppNativeItemTextField = -9,
	UIVoterAppNativeItemSearchBar = -10,
	
	UIVoterAppNativeItemPicker = -11,
	UIVoterAppNativeItemDatePicker = -12,
	
	UIVoterAppNativeItemInfoLight = -13,
	UIVoterAppNativeItemInfoDark = -14,
	
	UIVoterAppNativeItemDisclosure = -15,
	
	UIVoterAppNativeItemContactAdd = -16
};
