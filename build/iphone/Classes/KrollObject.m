 ...
 * Copyright (c) 2009-2011 by VoterApp, Inc. All Rights Reserved.
...
//@interface VoterAppObject : NSObject
//@end

@interface VoterAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VoterAppObject class]])
		{
			for (NSString *key in [[(VoterAppObject*)o modules] allKeys])
			{
